...
class CSICamera(BaseCamera):
    ...
    def gstreamer_pipeline(self) :
        return 'nvarguscamerasrc ! video/x-raw(memory:NVMM), width=3264, height=2464, format=(string)NV12, framerate=(fraction)21/1 ! nvvidconv flip-method=2 ! nvvidconv ! video/x-raw, width=320, height=240, format=(string)BGRx ! videoconvert ! appsink'
    ...
    def poll_camera(self):
        ...
        self.frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)[80:240,0:320]
